package com.starline.users.aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(@com.starline.users.annotations.LogRequestResponse * *(..))")
    public void methodWithLoggedRequestResponse() {
    }


    @Pointcut("within(@com.starline.users.annotations.LogRequestResponse *)")
    public void classWithLogRequestResponse() {
    }

    @Pointcut("within(@com.starline.users.annotations.LogResponse *)")
